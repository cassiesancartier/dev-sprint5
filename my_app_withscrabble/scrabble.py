...
class Scrabble(flask.views.MethodView):
    ...
    def all_possibilities(self, filename, scrabble_letters, min_num_letters = 4, total_word_length = 9):
        """
    ...
    def post(self):
        ...
        word_min = 3
        word_max = len(scrabble_sig) + 1
        result = self.all_possibilities('words.txt', scrabble_sig, word_min, word_max)
        flask.flash('You can make the following words:')
        flask.flash(result)
